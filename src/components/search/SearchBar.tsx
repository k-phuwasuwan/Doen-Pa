...
export function SearchBar({ initialQuery = "" }: { initialQuery?: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative flex items-center gap-2">
      ...
      />
      <button type="submit" className="shimmer-glass flex min-h-11 shrink-0 items-center gap-2 rounded-xl bg-brand-600 px-4 font-semibold text-white shadow-glow transition-colors hover:bg-brand-700" aria-label="ค้นหา">
